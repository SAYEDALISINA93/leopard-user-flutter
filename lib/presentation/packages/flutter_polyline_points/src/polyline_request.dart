...
import 'package:leoparduser/presentation/packages/flutter_polyline_points/src/polyline_waypoint.dart';
import 'package:leoparduser/presentation/packages/flutter_polyline_points/src/request_enums.dart';
...
class PolylineRequest {
  ...
  Uri toUri({String? apiKey}) {
    ...
    if (proxy != null) {
      return proxy!.replace(queryParameters: _getParams());
    }

    return Uri.https(
      "maps.googleapis.com",
      "maps/api/directions/json",
      _getParams()..addAll({'key': apiKey}),
    );
  }
