...
import 'package:leoparduser/core/utils/debouncer.dart';
...
import 'package:leoparduser/presentation/components/text-form-field/location_pick_text_field.dart';
                      ...
                      SizedBox(
                        ...
                        child: GoogleMap(
                          ...
                          onTap: (LatLng position) async {
                            // Update the selected location based on current index
                            controller.changeCurrentLatLongBasedOnCameraMove(
                              position.latitude,
                              position.longitude,
                            );

                            // Pick the location and update address
                            await controller.pickLocation();

                            // Animate camera to the tapped position
