...
import 'package:leoparduser/data/controller/reference/reference_contrller.dart';
import 'package:leoparduser/data/repo/refer/reference_repo.dart';
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            HeaderText(
                              text:
                                  "${MyStrings.earn} ${controller.currencySym}${StringConverter.formatNumber(controller.repo.apiClient.getReferAmount())}",
