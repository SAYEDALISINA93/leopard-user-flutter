...
class GlobalPusherController extends GetxController {
  ...
  void onEvent(PusherEvent event) {
    try {
      ...
      // Parse event.data - it can be either String or Map
      ...
      if (event.data is String) {
        ...
        printX("Unknown event.data type: ${event.data.runtimeType}");
        return;
      }

      PusherResponseModel model = PusherResponseModel.fromJson(eventDataMap);
      ...
      printX("Error in onEvent: ${e.toString()}");
    }
  }
